...
public class ApplicationAddForm extends ActionForm {
	...
	public void setDesiredDate(String desiredDate) {
		try {
			application
					.setDesiredDate(dateString2Calendar(desiredDate));
		} catch (ParseException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void setAskedForPosterAndFlyerDate(String askedForPosterAndFlyerDate) {
		try {
			application
					.setAskedForPosterAndFlyerDate(dateString2Calendar(askedForPosterAndFlyerDate));
		} catch (ParseException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void setSendPosterAndFlyerDate(String sendPosterAndFlyerDate) {
		try {
			application
					.setSendPosterAndFlyerDate(dateString2Calendar(sendPosterAndFlyerDate));
		} catch (ParseException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
