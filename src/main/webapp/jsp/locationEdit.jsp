...
<html:form action="locationEdit" focus="name">

	<%-- print out the form data --%>
	<table border="1">
		<tr>
			<td><bean:message key="location.name" /></td>
			<td><html:text property="locationName" readonly="true" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2"><html:image src="img/but_save.gif"
				 border="0"
				alt="Save">
	...
	<html:hidden property="do" value="updateLocation" />
</html:form>
</div>
